...
function secondsToPace(secs) {
   ...
   mins = pad(mins % 60, 2);
   var seconds = pad(Math.round(secs % 60), 2);
   return hours + ':' + mins + ':' + seconds;
}

function processForm(focussedInputJq) {
   var paceSecondsPerK = paceToSeconds(focussedInputJq.val()) / focussedInputJq.data('k');
   (0, _jquery2.default)('input').not(focussedInputJq).each(function () {
      var k = (0, _jquery2.default)(this).data('k');
      (0, _jquery2.default)(this).val(secondsToPace(paceSecondsPerK * k));
   });
}

function initialise() {
   (0, _jquery2.default)('input').each(function () {
      (0, _jquery2.default)(this).keyup(function (ev) {
         if (isHoursMinsSecs((0, _jquery2.default)(this).val()) && (0, _keyboard.isNumberKey)(ev.which)) {
            processForm((0, _jquery2.default)(this));
         }
      });
   });
   (0, _jquery2.default)('#1m').trigger('keyup');
}

(0, _jquery2.default)(document).ready(initialise);
},{"./keyboard":2,"jquery":3}],2:[function(require,module,exports){
'use strict';
...
module.exports = { rightKeyCode: rightKeyCode, leftKeyCode: leftKeyCode, isNumberKey: isNumberKey };
